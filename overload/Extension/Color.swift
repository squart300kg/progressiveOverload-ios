...
struct MainColor {
    ...
    let primary = UIColor(hexString: "FF5E2E") // rgb 255 94 46
    let light_gray = UIColor(hexString: "EEEEEE") // rgb 255 94 46
    
    let main_orange = UIColor(hexString: "dd5e17")// rgb 255 120 26
    let orange_255 = UIColor(hexString: "FF781A")// rgb 255 120 26
}
